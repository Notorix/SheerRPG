package com.eatenalive3.sheerrpg.commands;
...
import com.eatenalive3.sheerrpg.main.LPlayer;
import com.eatenalive3.sheerrpg.main.SheerRPG;
import com.eatenalive3.sheerrpg.skills.Skill;
	...
	public Test(CommandSender sender, String[] args) {
		...
		if (hasPermission) {
			...
			ids.add(Bukkit.getServer().getScheduler()
					.scheduleSyncRepeatingTask(SheerRPG.plugin, new Runnable() {
						public void run() {
							//Random r = new Random();
							for (int i = 0; i < 1; i++) {
